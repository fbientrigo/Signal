...
eff = np.array([0.08, 0.15, 0.27, 0.39, 0.51, 0.57, 0.60])
...
with style_context("paper") as (colors, _profile):
    ...
    ax.scatter([mass[idx]], [eff[idx]], s=34, color=colors["highlight"], zorder=4)
    ax.annotate(
        "benchmark",
        xy=(mass[idx], eff[idx]),
        xytext=(6, 8),
    ...
    ax.set(xlabel=r"Mass [GeV]", ylabel="Efficiency", ylim=(0, 0.75))
