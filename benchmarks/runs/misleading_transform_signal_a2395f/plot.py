...
ax.set_xlim(-3, 105)
ax.set_ylim(-1.5, 20)
ax.set_xlabel("Dose (Gy)", fontweight="medium")
ax.set_ylabel("Sensor Response (mV)", fontweight="medium")
ax.set_title("Sensor Response vs. Dose", fontweight="bold", pad=8)
...
axins.annotate("0 Gy: −0.20 mV", xy=(0.0, -0.20), xytext=(0.3, -0.32),
               fontsize=7.0, color="#7f1d1d", fontweight="semibold",
               arrowprops=dict(arrowstyle="->", color="#b91c1c", lw=0.7, shrinkA=3, shrinkB=3))

# Inset limits and styling
axins.set_xlim(-0.2, 3.3)
axins.set_ylim(-0.45, 0.55)
axins.set_title("Low-dose detail (0–3 Gy)", fontsize=7.5, fontweight="bold", pad=4, color="#1e293b")
axins.set_xlabel("Dose (Gy)", fontsize=7.0, labelpad=2)
axins.set_ylabel("Response (mV)", fontsize=7.0, labelpad=2)
