...
def main():
    ...
    ax_zero.set_ylabel('Sensor Response (mV)', fontsize=12, fontweight='bold', color='#1a1a1a')
    ...
    fig.text(0.53, 0.04, 'Dose (Gy)', ha='center', fontsize=12, fontweight='bold', color='#1a1a1a')
    fig.suptitle('Sensor Response vs. Radiation Dose', fontsize=14, fontweight='bold', color='#1a1a1a', y=0.96)
