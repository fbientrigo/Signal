...
def main():
    ...
    fg_color = "#252525"
    grid_color = "#E5E3DC"
    color_a = "#332288"      # Slate blue
    color_b = "#88CCEE"      # Warm terracotta
    color_diff = "#44AA99"   # Muted red for negative difference
    ...
    ax1.set_xlabel("Edited X", fontsize=10, fontweight="bold")
    ax1.set_ylabel("Edited Y", fontsize=10, fontweight="bold")
    ax1.set_ylim(0, 5.4)
    ...
    ax1.set_title("Edited benchmark figure", fontsize=11, fontweight="bold", pad=12)
    ...
    ax2.set_xlabel("Edited X", fontsize=10, fontweight="bold")
    ax2.set_ylabel("Edited Y", fontsize=10, fontweight="bold")
    ...
    ax2.set_title("Edited benchmark figure", fontsize=11, fontweight="bold", pad=12)
