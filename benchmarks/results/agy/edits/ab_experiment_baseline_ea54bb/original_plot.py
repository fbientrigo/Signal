...
def main():
    ...
    ax1.text(
        ...
        ha='center', va='bottom', fontsize=10, fontweight='bold', color='#B91C1C'
    )

    ax1.set_xticks(x_pos)
    ax1.set_xticklabels(['Variant A\n(Baseline)', 'Variant B\n(Treatment)'], fontsize=11, fontweight='bold')
    ax1.set_ylabel('Conversion Rate (%)', fontsize=12, fontweight='bold', color='#1E293B')
    ax1.set_title('A. Conversion Rate Comparison (95% Wilson CI)', fontsize=12.5, fontweight='bold', pad=14, loc='left')
    ax1.set_ylim(0, 5.8)
    ...
    ax2.set_ylabel('Visitor Count', fontsize=12, fontweight='bold', color='#1E293B')
    ax2.set_title('B. Sample Volume & Traffic Allocation Breakdown', fontsize=12.5, fontweight='bold', pad=14, loc='left')
    ...
    legend_elements = [
        mpatches.Patch(facecolor='#CBD5E1', edgecolor='#94A3B8', label='Non-Converted Visitors'),
        mpatches.Patch(facecolor='#2563EB', label='Conversions (Variant A)'),
        mpatches.Patch(facecolor='#DC2626', label='Conversions (Variant B)')
    ]
    ...
    fig.suptitle(
        "A/B Test Experiment Results: Statistical Evaluation of Conversion Rates",
        fontsize=15,
        fontweight='bold',
        color='#0F172A',
        y=0.98
    ...
    fig.text(
        ...
        fontsize=9,
        color='#334155',
        bbox=dict(boxstyle='round,pad=0.6', facecolor='#F1F5F9', edgecolor='#CBD5E1', linewidth=1)
    )
