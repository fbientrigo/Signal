...
# Colors
primary_color = '#332288'  # Deep botanical green
fill_color = '#88CCEE'     # Softer green for confidence band
...
ax.set_title('Edited benchmark figure', fontweight='bold', pad=12)
