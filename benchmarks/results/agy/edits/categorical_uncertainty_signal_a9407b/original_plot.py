...
ax.set_xlabel("Detector Channel", fontweight="medium", labelpad=6)
ax.set_ylabel("Estimate", fontweight="medium", labelpad=6)
ax.set_title("Detector Channel Comparison", fontweight="bold", pad=8)
