...
def main():
    ...
    ax.axhline(0, color="gray", linestyle="--", linewidth=1.0, alpha=0.7, label="Freezing Point (0 °C)")
    ...
    # Formatting
    ax.set_title("Daily Temperature Time Series (January 1–14, 2026)", fontsize=14, fontweight="bold", pad=12)
