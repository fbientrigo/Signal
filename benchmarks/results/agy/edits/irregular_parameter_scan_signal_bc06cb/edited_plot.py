...
cmap = LinearSegmentedColormap.from_list('tol_muted', tol_colors)
...
ax.set_xlabel('Edited X', fontweight='bold', labelpad=8)
ax.set_ylabel('Edited Y', fontweight='bold', labelpad=8)
ax.set_title('Edited benchmark figure', pad=14, fontweight='bold', fontsize=12)
...
legend_elements = [
    ...
    Line2D([0], [0], marker='s', color='w', label='Excluded by theory',
           markerfacecolor='#94a3b8', markeredgecolor='#CC6677', markeredgewidth=2.0, markersize=10),
]
legend = ax.legend(
