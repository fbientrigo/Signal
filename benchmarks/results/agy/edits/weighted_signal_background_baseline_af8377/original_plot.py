...
def main():
    ...
    color_sig = '#0055A5'      # Deep Royal Blue
    color_sig_light = '#9ECAE1'
    color_bkg = '#D95F02'      # Vermilion
    color_bkg_light = '#FDBE85'
    color_tail = '#2CA02C'     # Green highlight
    color_tail_bg = '#E8F5E9'
    ...
    ax_main.text(
        ...
        fontsize=9.5, fontweight='bold', color='#1B5E20', ha='center', va='top',
    ...
    ax_main.set_ylabel('Expected Yield / 0.1 Bin', fontweight='bold')
    ax_main.set_ylim(0, 5.5)
    ax_main.set_xlim(0.0, 1.0)
    ax_main.grid(True, linestyle='--', alpha=0.45, zorder=0)
    ax_main.set_title('(a) Expected Differential Yield vs Score', fontweight='bold', loc='left', pad=8)
    ...
    ax_ratio.errorbar(
        ...
        color='#1A237E', markerfacecolor=color_sig, markeredgecolor='#1A237E',
    ...
    ax_ratio.set_xlabel('Classifier Score', fontweight='bold')
    ...
    ax_card.set_title('(b) Exposure Yields & Tail Enrichment Statistics', fontweight='bold', loc='left', pad=8)
    ...
    ax_cum.text(
        ...
        fontsize=8.5, color='#1B5E20', fontweight='bold', va='top',
    ...
    ax_cum.set_title('(c) Cumulative Yield Retention vs Cut', fontweight='bold', loc='left', pad=8)
    ...
    output_png = os.path.join(work_dir, 'plot.png')
