...
ax.set_xlabel('Detector Channel', fontsize=12, fontweight='bold', labelpad=10)
ax.set_ylabel('Estimate', fontsize=12, fontweight='bold', labelpad=10)
...
# Title and subtitle
plt.suptitle('Detector Channel Performance Comparison', fontsize=14, fontweight='bold', y=0.97)
ax.set_title('Estimates with reported uncertainty bounds [low, high]', fontsize=10.5, color='#555555', pad=10)
