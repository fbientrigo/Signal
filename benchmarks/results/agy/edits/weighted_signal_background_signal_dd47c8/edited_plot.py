...
c_sig = '#332288'       # Steel blue
c_sig_dark = '#332288'
c_bkg = '#88CCEE'       # Vermilion
c_bkg_dark = '#88CCEE'
c_tail_bg = '#DDCC77'   # Pale green highlight
c_tail_line = '#117733'
...
ax.set_title('Edited benchmark figure', pad=12)
...
# ---------------------------------------------------------
plt.tight_layout()
fig.savefig('edited_plot.png', dpi=300)
plt.close(fig)
